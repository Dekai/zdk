...
namespace Library.BLL
{
	...
	/// CostApply
	/// </summary>
	public partial class CostApplyService
	{
		private readonly ICostApply dal=DataAccess.CreateCostApply();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.CostApply GetModelByCache(int F_ID)
		{
			
			string CacheKey = "CostApplyModel-" + F_ID;
			...
			return (Library.Model.CostApply)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.CostApply> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.CostApply> DataTableToList(DataTable dt)
		{
			List<Library.Model.CostApply> modelList = new List<Library.Model.CostApply>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.CostApply model;
        ...
        {
            return dal.GetViewList(projectlist, wfstate, startTime, endTime);
        }
    }
}
