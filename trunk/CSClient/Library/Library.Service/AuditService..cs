...
namespace Library.BLL
{
	...
	{
		private readonly IAudit dal=DataAccess.CreateAudit();
        public AuditService()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Audit GetModelByCache(int F_ID)
		{
			
			string CacheKey = "AuditModel-" + F_ID;
			...
			return (Library.Model.Audit)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Audit> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Audit> DataTableToList(DataTable dt)
		{
			List<Library.Model.Audit> modelList = new List<Library.Model.Audit>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.Audit model;
