...
namespace Library.BLL
{
	...
	/// EmployeeAttendace
	/// </summary>
	public partial class EmployeeAttendaceService
	{
		private readonly IEmployeeAttendace dal=DataAccess.CreateEmployeeAttendace();
		public EmployeeAttendaceService()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.EmployeeAttendace GetModelByCache(int F_ID)
		{
			
			string CacheKey = "EmployeeAttendaceModel-" + F_ID;
			...
			return (Library.Model.EmployeeAttendace)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.EmployeeAttendace> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.EmployeeAttendace> DataTableToList(DataTable dt)
		{
			List<Library.Model.EmployeeAttendace> modelList = new List<Library.Model.EmployeeAttendace>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.EmployeeAttendace model;
        ...
        {
            return dal.GetSummer(projectids, startdate, enddate);
        }
	}
}
