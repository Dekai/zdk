...
namespace Library.BLL
{
	...
	/// DataDicInfo
	/// </summary>
	public partial class DataDicInfoService
	{
		private readonly IDataDicInfo dal=DataAccess.CreateDataDicInfo();
		public DataDicInfoService()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.DataDicInfo GetModelByCache(int F_ID)
		{
			
			string CacheKey = "DataDicInfoModel-" + F_ID;
			...
			return (Library.Model.DataDicInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.DataDicInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.DataDicInfo> DataTableToList(DataTable dt)
		{
			List<Library.Model.DataDicInfo> modelList = new List<Library.Model.DataDicInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.DataDicInfo model;
