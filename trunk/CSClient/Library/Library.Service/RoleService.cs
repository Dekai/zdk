...
namespace Library.BLL
{
	...
	public partial class RoleService
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Role GetModelByCache(int F_ID)
		{
			
			string CacheKey = "RoleModel-" + F_ID;
			...
			return (Library.Model.Role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Role> DataTableToList(DataTable dt)
		{
			List<Library.Model.Role> modelList = new List<Library.Model.Role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.Role model;
