...
namespace Library.BLL
{
	...
	{
		private readonly IProject dal=DataAccess.CreateProject();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Project GetModelByCache(int F_ID)
		{
			
			string CacheKey = "ProjectModel-" + F_ID;
			...
			return (Library.Model.Project)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Project> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Project> DataTableToList(DataTable dt)
		{
			List<Library.Model.Project> modelList = new List<Library.Model.Project>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.Project model;
        ...
        public List<Model.Struct.NameValue> GetNameViewList(string swhere)
        {
            return dal.GetNameViewList(swhere);
        }
    }
}
