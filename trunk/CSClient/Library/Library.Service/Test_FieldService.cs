...
namespace Library.BLL
{
	...
	/// Test_Field
	/// </summary>
	public partial class Test_FieldService
	{
		private readonly ITest_Field dal=DataAccess.CreateTest_Field();
		public Test_FieldService()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Test_Field GetModelByCache(int F_ID)
		{
			
			string CacheKey = "Test_FieldModel-" + F_ID;
			...
			return (Library.Model.Test_Field)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Test_Field> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Test_Field> DataTableToList(DataTable dt)
		{
			List<Library.Model.Test_Field> modelList = new List<Library.Model.Test_Field>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.Test_Field model;
