...
namespace Library.BLL
{
	...
	/// LoginUser
	/// </summary>
	public partial class LoginUserService
	{
		private readonly ILoginUser dal=DataAccess.CreateLoginUser();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.LoginUser GetModelByCache(int F_ID)
		{
			
			string CacheKey = "LoginUserModel-" + F_ID;
			...
			return (Library.Model.LoginUser)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.LoginUser> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.LoginUser> DataTableToList(DataTable dt)
		{
			List<Library.Model.LoginUser> modelList = new List<Library.Model.LoginUser>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.LoginUser model;
