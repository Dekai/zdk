...
namespace Library.BLL
{
	...
	public partial class EmployeeService
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Employee GetModelByCache(int F_ID)
		{
			
			string CacheKey = "EmployeeModel-" + F_ID;
			...
			return (Library.Model.Employee)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Employee> GetModelList(string strWhere)
		{
        ...
        {
            return dal.GetRoleToUserName(p);
        }
    }
}
