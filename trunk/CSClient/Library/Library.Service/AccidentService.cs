...
namespace Library.BLL
{
	...
	{
		private readonly IAccident dal=DataAccess.CreateAccident();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Library.Model.Accident GetModelByCache(int F_ID)
		{
			
			string CacheKey = "AccidentModel-" + F_ID;
			...
			return (Library.Model.Accident)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Accident> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Library.Model.Accident> DataTableToList(DataTable dt)
		{
			List<Library.Model.Accident> modelList = new List<Library.Model.Accident>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Library.Model.Accident model;
        ...
        {
            return dal.GetTable(projectlist, startTime, endTime);
        }
    }
}
