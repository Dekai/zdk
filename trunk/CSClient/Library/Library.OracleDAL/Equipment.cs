...
namespace Library.SQLServerDAL
{
	...
	public partial class Equipment:IEquipment
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("F_ID", "T_Equipment"); 
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Library.Model.Equipment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_Equipment set ");
			strSql.Append("F_Name=@F_Name,");
			strSql.Append("F_Decs=@F_Decs,");
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Equipment GetModel(int F_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_ID,F_Name,F_Decs,F_Order,F_IsDelete from T_Equipment ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
			...
			Library.Model.Equipment model=new Library.Model.Equipment();
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Equipment DataRowToModel(DataRow row)
		{
			Library.Model.Equipment model=new Library.Model.Equipment();
			if (row != null)
			{
				...
				if(row["F_Decs"]!=null && row["F_Decs"].ToString()!="")
				{
					model.F_Decs= row["F_Decs"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_ID,F_Name,F_Decs,F_Order,F_IsDelete ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" F_ID,F_Name,F_Decs,F_Order,F_IsDelete ");
			strSql.Append(" FROM T_Equipment ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
