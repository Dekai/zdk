...
namespace Library.SQLServerDAL
{
	...
	public partial class Employee:IEmployee
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("F_ID", "T_Employee"); 
		}
		...
		public bool Delete(int F_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Employee ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_ID,F_Name,F_Mobile,F_IsDelete ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" F_ID,F_Name,F_Mobile,F_IsDelete ");
			strSql.Append(" FROM T_Employee ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Employee T ");
        ...
        public string GetRoleToUserName(string p)
        {
            string sSQL = "SELECT e.F_Name FROM T_LoginUser u  inner join T_Role r on r.F_ID = u.F_RoleID inner join T_Employee e on e.F_ID = u.F_UserID  and r.F_Name = '" + p + "'";

            DataTable dt = DbHelperSQL.Query(sSQL).Tables[0];
            if (dt.Rows.Count > 0)
            {
                return dt.Rows[0]["F_Name"].ToString();
            }
            else
            {
                return "";
