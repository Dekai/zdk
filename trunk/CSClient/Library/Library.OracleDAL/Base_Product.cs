...
namespace Library.SQLServerDAL
{
	...
	/// 数据访问类:Base_Product
	/// </summary>
	public partial class Base_Product:IBase_Product
	{
		public Base_Product()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("F_ID", "T_Base_Product"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Library.Model.Base_Product model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Library.Model.Base_Product model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Base_Product GetModel(int F_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_ID,F_Name,F_Content,F_Money,F_Time,F_WF_StateID,F_UserID from T_Base_Product ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
			...
			Library.Model.Base_Product model=new Library.Model.Base_Product();
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Base_Product DataRowToModel(DataRow row)
		{
			Library.Model.Base_Product model=new Library.Model.Base_Product();
			if (row != null)
			{
        ...
        public PagerTable GetPagerList(string swhere, string orderby, int pageindex, int pagesize)
        {
            ...
            pt.TotalCount = DbHelperSQL.GetCount("T_Base_Product b", strWhere);

            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select e.F_Name as UserName,w.F_StateName,  b.F_ID,b.F_Name,b.F_Content,b.F_Money,b.F_Time,b.F_WF_StateID,b.F_UserID from T_Base_Product b");
