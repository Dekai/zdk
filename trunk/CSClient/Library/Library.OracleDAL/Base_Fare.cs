...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2015/5/18 15:07:13   N/A    初版
*
...
namespace Library.SQLServerDAL
{
	...
	/// 数据访问类:Base_Fare
	/// </summary>
	public partial class Base_Fare:IBase_Fare
	{
		public Base_Fare()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("F_ID", "T_Base_Fare"); 
		}
		...
		public bool Exists(int F_ID)
		{
			...
			strSql.Append("select count(1) from T_Base_Fare");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Library.Model.Base_Fare model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_Base_Fare(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Library.Model.Base_Fare model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_Base_Fare set ");
		...
		public bool Delete(int F_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Base_Fare ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Base_Fare GetModel(int F_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_ID,F_Name,F_Content,F_Money,F_Time,F_WF_StateID,F_UserID from T_Base_Fare ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
			...
			Library.Model.Base_Fare model=new Library.Model.Base_Fare();
		...
		/// 得到一个对象实体
		/// </summary>
		public Library.Model.Base_Fare DataRowToModel(DataRow row)
		{
			Library.Model.Base_Fare model=new Library.Model.Base_Fare();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM T_Base_Fare ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Base_Fare T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_Base_Fare";
        ...
        public PagerTable GetPagerList(string swhere, string orderby, int pageindex, int pagesize)
        {
            ...
            pt.TotalCount = DbHelperSQL.GetCount("T_Base_Fare b", strWhere);

            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select e.F_Name as UserName,w.F_StateName,  b.F_ID,b.F_Name,b.F_Content,b.F_Money,b.F_Time,b.F_WF_StateID,b.F_UserID from T_Base_Fare b");
