...
{
	/// <summary>
	/// Test_Field_Templete:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Test_Field_Templete
	{
		...
		private int? _f_rowspan;
		private int? _f_colspan;
		...
		/// 
		/// </summary>
		public int? F_RowSpan
		{
			set{ _f_rowspan=value;}
			get{return _f_rowspan;}
		}
		/// <summary>
		/// 
		/// </summary>
		public int? F_ColSpan
		{
			set{ _f_colspan=value;}
			get{return _f_colspan;}
		}
		/// <summary>
		/// 
		/// </summary>
