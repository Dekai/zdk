...
public class MyApplyActivity extends MyBaseActivity implements OnItemClickListener, OnClickListener, OnItemSelectedListener {
	...
	public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
		...
		intent.putExtra("showType", "MyApply");
	...
	class LoadCostApply extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			try {
				...
				nameValuePairs.add(new BasicNameValuePair("operator", String.valueOf(getOperatorId())));
				if (costTypeId > 0) {
		...
		protected void onPostExecute(String s) {
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					adapter = new CostApplyListAdapter(MyApplyActivity.this, dataList, "MyApply");
